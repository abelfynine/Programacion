                        ...
                        <div className="mt-auto">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center">
                                ...
                                <a
                                    ...
                                    className="flex items-center justify-center w-full sm:w-40 h-14 rounded-xl bg-[#233448] hover:opacity-90 transition-all"
                                >
                                    <Image
                                        src={`${BASE_PATH}/images/amazonlogo.avif`}
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="flex items-center justify-center w-full sm:w-40 h-14 rounded-xl bg-[#FFE600] hover:opacity-90 transition-all"
                                >
                                    <Image
                                        src={`${BASE_PATH}/images/mercadolibrelogo.avif`}
